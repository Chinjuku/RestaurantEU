<div class="h-seceen bg-lightcream">
    ...
    <div class="flex space-x-4 py-[20px] px-[60px]">
        <a href="{{ route('chef.neworder') }}"
            class="text-3xl text-center  font-bold p-5 border-solid border-2 border-black hover:bg-lgreen hover:text-lightcream duration-500">ออร์เดอร์ใหม่</a>
        <a href="{{ route('chef.orderdone') }}"
    ...
    <div class="w-full justify-center h-[90%] flex flex-wrap gap-[30px] px-[60px]">
        ...
        <div class="w-[48%] h-[1000px] bg-cream rounded-[32px] py-[2%]">
            <h1 class="text-5xl text-center font-bold mb-6">ออร์เดอร์เสร็จสิ้น</h1>
                ...
                <div class="overflow-y-scroll overflow-x-hidden m-[4%] min-h-[60%] max-h-[60%]">
                    ...
                    {{-- <div class="flex justify-center mt-[5%]">
                        <div class="flex justify-center">
                            <a href="{{ route('chef.cookingdone', ['id' => $getid]) }}" class="bg-lightcream text-3xl text-darkgreen font-bold px-6 py-4  hover:bg-darkgreen hover:text-cream duration-500">เสร็จสิ้น</a>
                        </div>
                    </div> --}}
                @else
                    <div></div>

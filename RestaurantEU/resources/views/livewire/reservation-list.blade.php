            ...
            <tr class="bg-transparent text-wrap text-lg laptop:text-md border-b dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-600">
                ...
                <td class="px-6 laptop:px-4 py-[10px] pc:py-[12px] laptop:py-[8px]">
                    ...
                    <button 
                        ...
                        <svg width="24" height="24" viewBox="0 0 44 44" fill="yellow" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7.3335 12.8333H36.6668" stroke="yellow" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>

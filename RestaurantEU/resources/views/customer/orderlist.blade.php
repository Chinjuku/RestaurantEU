    ...
    <div class="group flex flex-col bg-[#FFF9F1] mx-[7%] my-[4%] px-[5%] py-[2%] border border-black rounded-2xl" tabindex="1">
        <div class=" flex justify-between  ">
            ...
            <div>
                ...
                <!-- leftbot -->
                <div class="flex ml-[5%]">
                    <div class="group-focus:-rotate-180"><svg fill="#B93636" width="30px" height="30px" viewBox="0 0 24 24" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="group flex flex-col bg-[#FFF9F1] mx-[7%] my-[4%] px-[5%] py-[2%] border border-black rounded-2xl" tabindex="1">
        <div class=" flex justify-between  ">
            ...
            <div>
                ...
                <!-- leftbot -->
                <div class="flex ml-[5%]">
                    <div><svg width="30px" height="30px" viewBox="0 0 64 64" enable-background="new 0 0 64 64" id="Layer_1" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <div class="ml-[10%] text-[#E38854] px-[2%]">เตรียมอาหาร</div>
                </div>
            </div>
            <!-- right -->
            <div class="flex right-0">
        ...
        <div class=" flex justify-between  ">
            ...
            <div>
                ...
                <div class="flex ml-[5%]">
                    ...
                    <div class="ml-[10%] text-[#DAAF6F]">รอเสิร์ฟ</div>
                </div>
            </div>
            <!-- right -->
            <div class="flex right-0">

...
<body class="bg-lightcream flex justify-center items-center flex-col -">
    <div class="flex justify-center items-center h-screen flex-col">
        <div class="bg-darkgreen px-20 py-10 text- border rounded-3xl flex justify-center items-center flex-col absolute">
            <h2 class="text-lightcream text-[32px] mb-5">การจองโต๊ะสำเร็จ</h2>
        ...
        <div class="mt-[95%]">
            <div class="flex justify-center items-center flex-row gap-6 text-darkgreen">
            <svg width="30" height="30" viewBox="0 0 40 40" fill="0d4f4e" xmlns="http://www.w3.org/2000/svg">>
                ...
                <i class='bx bxl-facebook-circle bx-md' style='color:#0d4f4e' class="mx-6"></i>
                <span class="flex justify-center items-center flex-row gap-5">
                    <i class='bx bx-envelope bx-md' style='color:#0d4f4e'></i>
                    <h5 class="text-[24px]">email@xxxx.com</h5>
                </span>
                <span class="flex justify-center items-center flex-row gap-5">
                    <i class='bx bx-phone-call bx-md' style='color:#0d4f4e'></i>
                    <h5 class="text-[24px]">xxx-xxx-xxxx</h5>
                </span>
